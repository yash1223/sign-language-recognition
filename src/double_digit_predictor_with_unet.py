...
for iz in range(2):
	...
	for c in range(30,0,-1):
		...
		#print(c)
		if iz==0:
			cv2.putText(fimage, 'Do the gesture for digit at tenth\'s position', (230, 50), font, 0.8, (0, 255, 0), 2, cv2.LINE_AA)
		else :
			cv2.putText(fimage, 'Do the gesture for digit at unit\'s position', (230, 50), font, 0.8, (0, 255, 0), 2, cv2.LINE_AA)
	...
	im2 = cv2.dilate(im2,kernel,iterations=7)
...
max1223 = int(max12[0]*10 + max12[1])
